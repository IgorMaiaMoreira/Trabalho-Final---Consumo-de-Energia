namespace ControleDeLuz
{
    public class ContaResidencial : ContaBase{
        ...
        public ContaResidencial(int numeroInstalacao, Consumidor titular, double leituraMesAnterior, double leituraMesAtual) : base(numeroInstalacao, titular, leituraMesAnterior, leituraMesAtual) { }
